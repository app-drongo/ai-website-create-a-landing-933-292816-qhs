  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { name: 'API Connectivity', href: '/api' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Data Protection', href: '/cookies' },
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                ...
                Fortune 500 companies to modernize their business processes and unlock data
                potential.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">+1 (888) SAP-HELP</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Weekly SAP trends, integration best practices, and enterprise solutions. Unsubscribe
                anytime.
              </p>
            </div>
          </div>
