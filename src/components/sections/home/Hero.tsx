...
export default function Hero() {
  ...
  const handleSecondaryAction = () => {
    setIsModalOpen(true); // Open integration demo video
  };
        ...
        <div className="grid items-center gap-12 py-20 sm:py-24 lg:grid-cols-2 lg:gap-20 lg:py-32">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
              Connect your SAP system with any third-party application. Our expert consultants
              deliver enterprise-grade integrations that scale with your business growth.
            </p>
          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-2xl border bg-card shadow-2xl">
              <div className="aspect-[16/10] relative">
                <Image
                  ...
                  alt="SAP ERP integration dashboard showing real-time data flows"
                  fill
            ...
            <div className="absolute -left-6 -bottom-6 hidden w-36 rounded-xl border bg-background/90 p-3 shadow-xl sm:block">
              ...
              <p className="text-sm">
                <span className="font-semibold">100%</span> Sync Rate
              </p>
            </div>
          </div>
        </div>
